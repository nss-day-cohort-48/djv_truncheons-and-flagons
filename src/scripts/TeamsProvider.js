...
export const addTeam = (teamName) => {
    ...
    if (checkDuplicateTeam(teamName)) {
        ...
        document.getElementById(
            "userAddInputInfo"
        ).innerHTML = `<div class="warning"><img id="warningIcon" src="./images/warning.png"> ${teamName} is already taken. Please select another team name. <img id="warningIcon" src="./images/warning.png"></div>`;
    }
};
